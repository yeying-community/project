...
> - 扫描范围: `resources/assets/js` 下所有 `.js` / `.vue` 文件（共 270 个）
...
- **emit（1）**
  - `resources/assets/js/store/actions.js:4754`
- **on（1）**
...
- **emit（1）**
  - `resources/assets/js/store/actions.js:4825`
- **on（2）**
...
- **emit（2）**
  - `resources/assets/js/store/actions.js:2700`
  - `resources/assets/js/store/actions.js:3693`
- **on（2）**
...
- **emit（1）**
  - `resources/assets/js/store/actions.js:5332`
- **on（1）**
...
- **emit（1）**
  - `resources/assets/js/store/actions.js:4442`
- **on（1）**
...
- **emit（1）**
  - `resources/assets/js/store/actions.js:4965`
- **on（1）**
...
- **emit（2）**
  ...
  - `resources/assets/js/pages/manage/setting/index.vue:193`
- **on（1）**
...
- **on（1）**
  - `resources/assets/js/pages/login.vue:249`
- **off（1）**
  - `resources/assets/js/pages/login.vue:255`
...
- **emit（3）**
  ...
  - `resources/assets/js/store/actions.js:4742`
- **on（1）**
...
- **emit（1）**
  - `resources/assets/js/store/actions.js:4759`
- **on（2）**
